...
define config.name = _("Возможно любовь всё исправит?")
...
define gui.about = _p(""" Эта игра создана студентами в качестве выпускной работы.

Авторы - Эрик Салмин, Арсений Чистяков

Об игре - Ничем непримечательный алкоголик 20 лет. Зависимость, вызванная смертью близкого человека медленно убивала изнутри. Вина за содеянное висела темным облаком на парне.
Лишь фотография со школьных времён и общение с психологом подталкивает в иное русло.
""")
...
define config.main_menu_music = "muzforgame.mp3"
...
define config.save_directory = "Proba-1701372660"
...
define config.window_icon = "gui/MLWFE.png"
...
style_prefix "phone" # префикс для стилей, определенных в CSS файле

define gui.screen_style_prefix = "phone" # применение стилей к экранам
